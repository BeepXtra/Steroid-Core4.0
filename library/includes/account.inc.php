...
class Account
{
    ...
    public function valid_alias($id)
    {
        global $db;
        $orig=$id;
        $banned=["MERCURY","DEVS","DEVELOPMENT", "MARKETING", "MERCURY80","DEVBPC", "DEVELOPER","DEVELOPERS","BPCDEV", "DONATION","MERCATOX", "OCTAEX", "MERCURY", "STEROID", "STEROID4", "BEEPXTRA", "BEEP", "BPC", "BEEPXCOIN", "BEEPIQ", "ESCROW","OKEX","BINANCE","CRYPTOPIA","HUOBI","ITFINEX","HITBTC","UPBIT","COINBASE","KRAKEN","BITSTAMP","BITTREX","POLONIEX"];
        $id=strtoupper($id);
        $id = san($id);
