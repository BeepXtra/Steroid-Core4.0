...
class STx {
    ...
    public function add($block, $height, $x)
    {
        ...
        if ($x['version']==50) {
            ...
            foreach ($r as $g) {
                ...
                _log("Distributing to $g[account] for $g[balance] units - $coins BPC", 3);
    ...
    public function check($x, $height = 0)
    {
        ...
        if ($x['version']==50) {
            ...
            // If the price is set, it cannot be sold by the asset wallet at a dfferent price. Max price 1.000.000 bpc
